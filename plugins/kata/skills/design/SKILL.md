...
AskUserQuestion ツールが利用可能なら、選択肢を提示して選んでもらう形にする。構成の比較が要る質問では、選択肢ごとの違いを短く並べた preview を添えてもよい。ツールが利用できない環境では、本文中に選択肢を箇条書きで列挙し、番号や記号で選べるようにする。
