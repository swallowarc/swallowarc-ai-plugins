...
判断材料が選択肢（label / description / preview）に収まる分量なら、AskUserQuestion で選ばせる。収まらない分量——設計セクションの本文や spec の全文など——を承認してもらう場合は、その本文をテキストで提示してターンを終える。承認は次の返信で受ける。長い本文とダイアログを同一ターンに並べない。
