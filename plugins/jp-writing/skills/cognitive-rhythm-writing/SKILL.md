...
作業前に `jp-writing:japanese-tech-writing` スキル（本スキルと同じプラグイン内の `../japanese-tech-writing/SKILL.md`）を読む。
...
本スキルは k16shikano 氏公開の gist をほぼ原文のまま収録したものである（変更点は「併用する規範」の参照表記と本節の追記のみ）。原典のライセンスは Unlicense（パブリックドメイン献呈）。

- 原典: https://gist.github.com/k16shikano/eb2929f13ed19c97188393d297be8432
- 収録リビジョン: a3b1e26（2026-07-09 時点の最新）
- ライセンスの根拠: [作者のライセンス方針 gist](https://gist.github.com/k16shikano/67625f2a7d96e3bbdfae8d571a936063)（public gist 全件に Unlicense を適用すると明記）
